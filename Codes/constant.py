...
# ----- Python ----- 
"Python": """ ### Python
🥇 Over the past four years, I have extensively utilized Python in my work as a data scientist, and I can confidently say that **it has become my preferred tool** for the most of data science tasks. 

💻 I have developed proficiency in **data scraping, data analysis, statistical modeling, machine learning, and data visualization using Python.**   
""",

# ----- R -----
"R": """ ### R
🎓 Over the past three years, I've specialized in using R for data analysis in both during my studies and in my professional career. 

📈 I've grown confident in crafting **statistical models, conducting in-depth statistical analyses, and weaving data into captivating visualizations.** 

💼 I look forward to further exploring the power of R in my data science journey. 
""",

# ----- Tableau -----
"Tableau": """ ### Tableau
📊 Over the past year, **I've diligently pursued expertise in Tableau through various courses**. However, I've yet to apply this knowledge in a real-world context. 

🙏 I'm eagerly anticipating the opportunity to put my Tableau skills to practical use soon! 
""",

# ----- MySQL -----
"Mysql": """ ### MySQL
📚 I have successfully **completed two courses on MySQL**, and I've already applied my knowledge in short-term projects.

💼 However, I am now eager and confident to take on more complex challenges in this field.
""",    

# ----- Excel -----
"Excel": """ ### Excel
📊 I often find myself working with Excel, as it's one of the most powerful tools in the world of data. However, my knowledge in Excel is somewhat basic, I must admit.

🚀 **If a project that involves Excel comes my way, I see it as a fantastic opportunity to learn and grow.**
""",

# ----- GitHub -----
"Github": """ ### GitHub
🌟 In the past year, I've adopted GitHub into my toolkit, and **it has quickly become an indispensable asset**. I now use GitHub consistently for the most of my projects. 

🌐 Currently, I utilize it for personal purposes, but I am confident in its applicability in broader professional contexts.
""",
}
...
contact = {
"text": """I'm available for both short-term project collaborations and longer-term, part-time engagements, ready to contribute to your success. 🌟 

If my expertise aligns with your needs, I welcome the opportunity to discuss potential collaborations. Please feel free to get in touch. 👔🤝
"""
}